package com.xeniac.chillclub.core.presentation.common.ui.theme
    ...
    return remember(key1 = currentAppLocale) {
        when (currentAppLocale) {
            AppLocale.Default, AppLocale.EnglishGB, AppLocale.EnglishUS -> FontFamily(
                listOf(
                    Font(
                        resId = R.font.sofia_sans_thin,
                        weight = FontWeight.Thin
                    ),
                    Font(
                        resId = R.font.sofia_sans_extra_light,
                        weight = FontWeight.ExtraLight
                    ),
                    Font(
                        resId = R.font.sofia_sans_light,
                        weight = FontWeight.Light
                    ),
                    Font(
                        resId = R.font.sofia_sans_regular,
                        weight = FontWeight.Normal
                    ),
                    Font(
                        resId = R.font.sofia_sans_medium,
                        weight = FontWeight.Medium
                    ),
                    Font(
                        resId = R.font.sofia_sans_semi_bold,
                        weight = FontWeight.SemiBold
                    ),
                    Font(
                        resId = R.font.sofia_sans_bold,
                        weight = FontWeight.Bold
                    ),
                    Font(
                        resId = R.font.sofia_sans_extra_bold,
                        weight = FontWeight.ExtraBold
                    ),
                    Font(
                        resId = R.font.sofia_sans_black,
